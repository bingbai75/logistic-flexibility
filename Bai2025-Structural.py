...
class OptimizeLatentModel:
    ...
    def _read_data_city(self):
        ...
        unified_file_path = join(self.args.projdir, 'Data_simulated', 'customer_info_loc.csv')
        
        self.customer_info_loc = pd.read_csv(unified_file_path, sep=',', header=0)
        
        # Load perturbed station coordinates
        coord_file_path = join(self.args.projdir, 'Data_simulated', 'station_coordinates_perturbed.csv')
    ...
    def _read_gaussian(self):
        ...
        """
        gaussian_params_path = join(self.args.projdir, 'Data_simulated', 'gaussian_params.csv')
...
if __name__ == '__main__':
    ...
    data_dir = join(projdir, 'Data_simulated')
